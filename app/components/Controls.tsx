        ...
        <div className="flex bg-[#101014] rounded-full">
          <span
            className={`rounded-tl-[2rem] rounded-bl-[2rem] ps-0.5 py-0.5 ${
              microphoneOpen
                ? "bg-gradient-to-r bg-gradient to-[#e0ef13] from-red-500"
                : "bg-white"
            }`}
          >
            <Tooltip showArrow content="Toggle microphone on/off.">
              ...
              >
                ...
                <div className="w-auto flex items-center justify-center shrink-0">
                  <MicrophoneIcon micOpen={microphoneOpen} className="text-gray-400 h-5 md:h-6" />
                </div>
                {/* <span>
                {microphoneOpen ? (
                  <>Now listening...</>
          ...
          <div className="flex-grow bg-white py-0.5 inline">
            <div className=" bg-[#101014] h-full">
              <TextareaAutosize
                ...
                spellCheck={false}
                autoCorrect="off"
                className="py-2 md:py-4 -mb-[0.4rem] min-h-10 overflow-hidden sm:px-4 w-full resize-none bg-[#101014] text-light-900 border-0 text-sm text-gray-400 sm:text-base outline-none focus:ring-0"
          ...
          <div className="inline h-auto rounded-tr-[2rem] rounded-br-[2rem] bg-white pe-0.5 py-0.5">
            <Tooltip showArrow content="Send a message.">
              <button type="submit" className="w-16 md:w-24 h-full py-2 md:py-4 px-2 rounded-tr-[2rem] rounded-br-[2rem] font-bold bg-[#101014] text-light-900 text-sm sm:text-base flex items-center justify-center">
                {/* <span>Send text</span> */}
                <SendIcon className="text-gray-400 w-5 md:w-6" />
              </button>
            </Tooltip>
          </div>
        </div>
