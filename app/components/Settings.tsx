...
const ModelSelection = ({
  ...
  return (
    <Select
      defaultSelectedKeys={["aura-model-Helios"]}
      selectedKeys={[model]}
      ...
      <div className="flex items-center gap-2.5 text-sm">
        <span className="bg-gradient-to-r to-[#13EF93]/50 from-[#149AFB]/80 rounded-full flex">
          <a
            ...
            onClick={onOpen}
          >
            <CogIcon className="text-gray-400 w-5 h-5 transition-transform ease-in-out duration-2000 group-hover:rotate-180" />
            <span className="text-gray-400 ml-2.5 text-xs">Change settings</span>
          </a>
        </span>
